            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data"
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="gate2play_stc_heading_title"
                                value="<?php echo $gate2play_stc_heading_title; ?>"
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <select name="gate2play_stc_status" class="form-control">
                                <option value="1"
                                    <?php echo ($gate2play_stc_status == '1') ? 'selected="selected"' : ''; ?>>
                                    <?php echo $text_enabled; ?></option>
                                <option value="0"
                                    <?php echo ($gate2play_stc_status == '0') ? 'selected="selected"' : ''; ?>>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <select name="gate2play_stc_connector" class="form-control">
                                <?php foreach ($entry_all_connector as $connector_val => $connector_name) { ?>
                                <option value="<?php echo $connector_val; ?>"
                                    <?php echo ($gate2play_stc_connector == $connector_val) ? 'selected="selected"' : ''; ?>>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <select name="gate2play_stc_testmode" class="form-control">
                                <option value="0"
                                    <?php echo ($gate2play_stc_testmode == '0') ? 'selected="selected"' : ''; ?>>
                                    <?php echo $entry_testmode_off; ?></option>
                                <option value="1"
                                    <?php echo ($gate2play_stc_testmode == '1') ? 'selected="selected"' : ''; ?>>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <select name="gate2play_stc_base_currency" class="form-control">
                                <?php foreach ($entry_all_currencies as $code => $value) { ?>
                                <option value="<?php echo $value; ?>"
                                    <?php echo ($gate2play_stc_base_currency == $value) ? 'selected="selected"' : ''; ?>>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <select name="gate2play_stc_trans_type" class="form-control">
                                <?php foreach ($entry_all_trans_type as $trans_type_val => $trans_type) { ?>
                                <option value="<?php echo $trans_type_val; ?>"
                                    <?php echo ($gate2play_stc_trans_type == $trans_type_val) ? 'selected="selected"' : ''; ?>>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <select name="gate2play_stc_trans_mode" class="form-control">
                                <?php foreach ($entry_all_trans_mode as $trans_mode_val => $trans_mode) { ?>
                                <option value="<?php echo $trans_mode_val; ?>"
                                    <?php echo ($gate2play_stc_trans_mode == $trans_mode_val) ? 'selected="selected"' : ''; ?>>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="gate2play_stc_channel" value="<?php echo $gate2play_stc_channel; ?>"
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="gate2play_stc_access_token"
                                value="<?php echo $gate2play_stc_access_token; ?>"
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            ...
                            <label class="checkbox-inline">
                                <input type="checkbox" name="gate2play_stc_brands[]" value="<?php echo $payment; ?>"
                                    <?php echo (is_array($gate2play_stc_brands) && in_array($payment, $gate2play_stc_brands)) ? 'checked="checked"' : ''; ?> />
                                <?php echo $name; ?>
                            </label>
                            <?php
                                if ($i % 2 == 0) {
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <select name="gate2play_stc_payment_style" class="form-control">
                                <?php foreach ($entry_all_payment_style as $payment_style_val => $payment_style) { ?>
                                <option value="<?php echo $payment_style_val; ?>"
                                    <?php echo ($gate2play_stc_payment_style == $payment_style_val) ? 'selected="selected"' : ''; ?>>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <select name="gate2play_stc_order_status_id" class="form-control">
                                <?php foreach ($order_statuses as $order_status) { ?>
                                <option value="<?php echo $order_status['order_status_id']; ?>"
                                    <?php echo ($order_status['order_status_id'] == $gate2play_stc_order_status_id) ? 'selected="selected"' : ''; ?>>
                    ...
                    <div class="form-group required">
                        ...
                        <div class="col-sm-10">
                            <select name="gate2play_stc_order_status_failed_id" class="form-control">
                                <option value="0"
                                    <?php echo ('0' == $gate2play_stc_order_status_failed_id) ? 'selected="selected"' : ''; ?>>
                                    <?php echo $text_missing; ?></option>
                                <?php foreach ($order_statuses as $order_status) { ?>
                                <option value="<?php echo $order_status['order_status_id']; ?>"
                                    <?php echo ($order_status['order_status_id'] == $gate2play_stc_order_status_failed_id) ? 'selected="selected"' : ''; ?>>
                                    <?php echo $order_status['name']; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    ...
                    <div class="form-group required">
                        <label class="col-sm-2 control-label"
                            for="input-mailerrors"><?php echo str_replace('admin_email', $gate2play_stc_admin_email, $entry_mailerrors); ?></label>
                        <div class="col-sm-10">
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="gate2play_stc_mailerrors" value="1"
                                        <?php echo ($gate2play_stc_mailerrors == '1') ? 'checked="checked"' : ''; ?> />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="gate2play_stc_sort_order" value="<?php echo $gate2play_stc_sort_order; ?>"
